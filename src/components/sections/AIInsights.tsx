          ...
          <div className="lg:col-span-7 flex flex-col gap-2.5">
            {INSIGHTS.map((x, i) => {
              ...
              return (
                ...
                >
                  {/* Side accent rail */}
                  <div aria-hidden className="absolute left-0 top-5 bottom-5 w-[2px] bg-ember-500/40 rounded-r-full group-hover:bg-ember-500 transition-colors" />
                  ...
                  <div className="flex items-start gap-4 pl-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-3">
                        <span className="syslabel text-[0.65rem] text-ink-ondarkSecondary">
                      ...
                      <div className="mt-4 flex items-center justify-between">
                        <span className="text-body-sm text-ember-500 mono">{x.metric}</span>
                        <span className="inline-flex items-center gap-1.5 text-body-sm text-ink-ondark group-hover:text-ember-500 transition-colors">
